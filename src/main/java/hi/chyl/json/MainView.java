...
public class MainView extends FrameView {
    ...
    private void initUI(){
        ...
        Image ico = new ImageIcon(getClass().getResource("/json.png")).getImage();
    ...
    private JToolBar createToolBar(){
        ...
        JButton btnAesFormat = new JButton("AES格式化");
        ...
        btnAesFormat.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
    ...
    private JMenuBar createMenuBar(){
        ...
        String fm = resourceMap.getString("fileMenu.text");
        fileMenu.setText(fm);
...
//      scheme.getStyle(Token.DATA_TYPE).foreground = Color.blue;
    ...
    private void formatJson(String... aesKey){
        //格式化字符串
        JsonElement jsonEle = null;
        JTextArea ta = getTextArea();
        String text = ta.getText();
        try {
            if(StringUtils.isNotBlank(text) && aesKey!=null && aesKey.length>0){
                text = AesUtil.decrypt(text,aesKey[0]);
            }
        ...
        tree.setCellRenderer(new DefaultTreeCellRenderer() {
            ...
            public Component getTreeCellRendererComponent(JTree tree, Object value, boolean sel, boolean expanded, boolean leaf,int row, boolean hasFocus) {
                  ...
                  if(tmp.startsWith(Kit.sArr)){
                      this.setIcon(new ImageIcon(getClass().getResource("/a.gif")));
                      this.setText(tmp.substring(2));
                  }else if(tmp.startsWith(Kit.sStr)){
                      this.setIcon(new ImageIcon(getClass().getResource("/v.gif")));
                      this.setText(tmp.substring(2));
                  }else if(tmp.startsWith(Kit.sObj)){
                      this.setIcon(new ImageIcon(getClass().getResource("/o.gif")));
                      this.setText(tmp.substring(2));
                  }else if(tmp.startsWith(Kit.sNum)){
                      this.setIcon(new ImageIcon(getClass().getResource("/n.gif")));
                      this.setText(tmp.substring(2));
                  }else if(tmp.startsWith(Kit.sNull)){
                      this.setIcon(new ImageIcon(getClass().getResource("/k.gif")));
                      this.setText(tmp.substring(2));
